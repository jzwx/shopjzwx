...
<html>
  ...
  <h3 align="center">修改商品</h3>
	<form action="editpro.bin" method="post" name="f1">
	<%
	 ...
	 %>
		<table width="70%" border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc" align="center"  style="border: solid 1px #000000;">
			...
			<tr>
				...
				<td style="border: solid 1px #000000;"><input type="text" name="pName" value="<%=rs.getString(2) %>" size="20"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style="border: solid 1px #000000;"><input type="text" name="pSn" value="<%=rs.getString(3) %>" size="20"/></td>
			</tr>
			<tr>
				<td align="right" style="border: solid 1px #000000;" width="20%">商品数量</td>
				<td style="border: solid 1px #000000;"><input type="text" name="pNum" value="<%=rs.getInt(4) %>"  size="20"/></td>
			</tr>
			<tr>
				<td align="right" style="border: solid 1px #000000;" width="20%">商品市场价</td>
				<td style="border: solid 1px #000000;"><input type="text" name="mPrice" value="<%=rs.getDouble(5) %>"  size="20"/></td>
			</tr>
			<tr>
				<td align="right" style="border: solid 1px #000000;" width="20%">商品小星价</td>
				<td style="border: solid 1px #000000;"><input type="text" name="iPrice" value="<%=rs.getDouble(6) %>"  size="20"/></td>
			</tr>
			<tr>
				<td align="right" style="border: solid 1px #000000;" width="20%">商品描述</td>
				<td style="border: solid 1px #000000;">
				<textarea name="pDesc" id="editor_id" value="<%=rs.getString(7) %>" style="width:100%;height:150px;"><%=rs.getString(7) %></textarea>
				</td>
			</tr>
			<tr>
				<td align="right" style="border: solid 1px #000000;" width="20%">商品图像</td>
				<td style="border: solid 1px #000000;">
					<input type="file"  name="filename" onChange="changeImage()"/><br/>
			...
			<tr>
				...
				<td style="border: solid 1px #000000;"><input type="text" name="pubTime" value="<%=rs.getString(9) %>" size="20"/></td>
			</tr>
			<tr>
