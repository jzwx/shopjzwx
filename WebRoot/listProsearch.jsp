...
function showDetail(id){
	...
	function change(val){
		window.location="listPro.jsp?order="+val;
	}
</script>
  </head>
...
<div class="details">
                    <div class="details_operation clearfix">
                        ...
                        <div class="fr">
                         ...
                         <%
                         String val=request.getParameter("keywords");
                        // System.out.println(val);
                         int n=10;
                        	...
                        	String sql="select * from jzwx_pro where pName like '%"+val+"%'";
                       ...
                       <%
                        ...
                        %>
                            ...
                            <%
                            	...
                            	sql="select count(id) from jzwx_pro where pName like '%"+val+"%'";
