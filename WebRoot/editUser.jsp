...
<html>
  ...
  <h3 align="center">管理员信息修改</h3>
  	<form name="f" action="edituser.bin" method="post">
 		<%
			...
			<tr>
				...
				<td style="border: solid 1px #000000;"><input type="text" name="username" value="<%=rs.getString(2) %>" placeholder="请输入用户名" size="20"/></td>
			</tr>
			<tr>
				<td align="right" style="border: solid 1px #000000;">密码</td>
				<td style="border: solid 1px #000000;"><input type="password" name="password" value="<%=rs.getString(3) %>" placeholder="请输入密码" size="21"/></td>
			</tr>
			<tr>
				<td align="right" style="border: solid 1px #000000;">性别</td>
				<td style="border: solid 1px #000000;"><input type="text" name="sex" value="<%=rs.getString(4) %>" placeholder="请输入性别" size="20"/></td>
			</tr>
			<tr>
				<td align="right" style="border: solid 1px #000000;">邮箱</td>
				<td style="border: solid 1px #000000;"><input type="text" name="email" value="<%=rs.getString(5) %>" placeholder="请输入邮箱" size="20"/></td>
			</tr>
			<tr align="center">
